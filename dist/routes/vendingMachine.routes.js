...
const vendingMachineController = __importStar(require("../controllers/vendingMachine.controller"));
...
router.get('/machines/:machineId/slots/:slotNumber/availability', vendingMachineController.checkProductAvailability);
