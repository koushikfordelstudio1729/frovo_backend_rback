...
logger_util_1.logger.info("🔀 === VENDOR ROUTES REGISTRATION ===");
...
logger_util_1.logger.info("📋 Registering company routes...");
...
logger_util_1.logger.info("📊 Registering dashboard routes...");
...
logger_util_1.logger.info("👑 Registering super admin routes...");
...
logger_util_1.logger.info("✅ Registering verification routes...");
...
logger_util_1.logger.info("➕ Registering vendor creation routes...");
...
logger_util_1.logger.info("📝 Registering general vendor routes...");
...
logger_util_1.logger.info("📄 Registering document routes...");
...
logger_util_1.logger.info("📜 Registering audit trail routes...");
...
logger_util_1.logger.info("✅ === ALL VENDOR ROUTES REGISTERED ===");
