...
exports.createQCTemplateSchema = zod_1.z.object({
    body: zod_1.z.object({
        title: zod_1.z.string().trim().min(1, "Template Title is required"),
...
exports.createWarehouseSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        code: zod_1.z
            ...
            .trim()
            .toUpperCase(),
        partner: zod_1.z.string().min(1, "Partner name is required").trim(),
        location: zod_1.z.string().min(5, "Location must be at least 5 characters").trim(),
        capacity: zod_1.z
            .number()
...
exports.updateWarehouseSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        code: zod_1.z
            ...
            .toUpperCase()
            .optional(),
        partner: zod_1.z.string().min(1, "Partner name is required").trim().optional(),
        location: zod_1.z.string().min(5, "Location must be at least 5 characters").trim().optional(),
        capacity: zod_1.z
            .number()
            .min(1, "Capacity must be at least 1")
            .max(1000000, "Capacity cannot exceed 1,000,000")
...
exports.getWarehousesQuerySchema = zod_1.z.object({
    query: zod_1.z.object({
        ...
        sortBy: zod_1.z.enum(["name", "code", "createdAt", "capacity"]).optional().default("createdAt"),
