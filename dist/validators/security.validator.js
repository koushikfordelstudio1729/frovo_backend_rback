...
exports.updateSecurityConfigSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        ipAllowlist: zod_1.z.array(zod_1.z.string().regex(/^(\d{1,3}\.){3}\d{1,3}(\/\d{1,2})?$/, 'Invalid CIDR notation')).optional(),
        ssoEnabled: zod_1.z.boolean().optional(),
        ssoConfig: zod_1.z.object({
