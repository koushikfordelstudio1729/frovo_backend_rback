...
exports.updateAccessRequestStatusSchema = zod_1.z.object({
    body: zod_1.z.object({
        status: zod_1.z
            .nativeEnum(enums_1.AccessRequestStatus)
            .refine(val => val === enums_1.AccessRequestStatus.APPROVED || val === enums_1.AccessRequestStatus.REJECTED, {
            message: "Status must be approved or rejected",
        }),
        comments: zod_1.z.string().max(500, "Comments cannot exceed 500 characters").trim().optional(),
    }),
});
...
exports.bulkUpdateAccessRequestsSchema = zod_1.z.object({
    body: zod_1.z.object({
        requestIds: zod_1.z.array(objectIdSchema).min(1, "At least one request ID is required"),
        status: zod_1.z
            .nativeEnum(enums_1.AccessRequestStatus)
            .refine(val => val === enums_1.AccessRequestStatus.APPROVED || val === enums_1.AccessRequestStatus.REJECTED, {
            message: "Status must be approved or rejected",
