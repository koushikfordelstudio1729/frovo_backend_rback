...
exports.createUserSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        departments: zod_1.z.array(objectIdSchema).optional().default([]),
...
exports.assignDepartmentsSchema = zod_1.z.object({
    body: zod_1.z.object({
        departmentIds: zod_1.z.array(objectIdSchema).min(1, "At least one department ID is required"),
    }),
});
exports.getUsersQueryBaseSchema = zod_1.z.object({
    ...
    sortBy: zod_1.z.enum(["name", "email", "createdAt", "lastLogin"]).optional().default("createdAt"),
