...
exports.createRoleSchema = zod_1.z.object({
    body: zod_1.z
        ...
        permissions: zod_1.z.array(zod_1.z.string().trim()).min(1, "At least one permission is required"),
        ...
        .refine(data => {
        if (data.scope.level !== enums_1.ScopeLevel.GLOBAL &&
