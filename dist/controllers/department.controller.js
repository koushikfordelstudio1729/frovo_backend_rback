...
exports.updateDepartment = (0, asyncHandler_util_1.asyncHandler)(async (req, res) => {
    const { id } = req.params;
    try {
        const department = await models_1.Department.findByIdAndUpdate(id, req.body, {
            new: true,
            runValidators: true,
        })
            .populate("roles", "name key")
...
exports.addMembers = (0, asyncHandler_util_1.asyncHandler)(async (req, res) => {
    ...
    try {
        const department = await models_1.Department.findByIdAndUpdate(id, { $addToSet: { members: { $each: userIds } } }, { new: true }).populate("members", "name email");
        if (!department) {
            return (0, response_util_1.sendNotFound)(res, constants_1.MESSAGES.DEPARTMENT_NOT_FOUND);
        }
...
exports.removeMember = (0, asyncHandler_util_1.asyncHandler)(async (req, res) => {
    ...
    try {
        const department = await models_1.Department.findByIdAndUpdate(id, { $pull: { members: userId } }, { new: true }).populate("members", "name email");
        if (!department) {
            return (0, response_util_1.sendNotFound)(res, constants_1.MESSAGES.DEPARTMENT_NOT_FOUND);
        }
