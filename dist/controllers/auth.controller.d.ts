...
export declare const registerCustomer: (req: Request, res: Response, next: import("express").NextFunction) => void;
...
export declare const logoutFromAllDevices: (req: Request, res: Response, next: import("express").NextFunction) => void;
