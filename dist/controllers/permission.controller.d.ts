...
export declare const searchPermissions: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const getPermissionStats: (req: Request, res: Response, next: import("express").NextFunction) => void;
