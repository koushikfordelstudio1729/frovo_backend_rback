...
const permissions = [
  ...
  },
  {
    ...
    module: PermissionModule.SETTLEMENT,
    action: PermissionAction.COMPUTE,
  ...
  // Ticket
  {
    ...
    action: PermissionAction.RESOLVE,
  ...
  // Inventory
  {
    ...
    action: PermissionAction.RECEIVE,
  ...
  },
  {
    ...
    module: PermissionModule.PURCHASE_ORDERS,
    action: PermissionAction.STATUS_UPDATE,
