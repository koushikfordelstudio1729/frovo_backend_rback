  ...
  try {
    ...
    const roleConfigs: { [key in SystemRole]?: any } = {
      ...
      [SystemRole.AREA_MANAGER]: {
        name: "Area Manager",
        key: "area_manager",
        systemRole: SystemRole.AREA_MANAGER,
        type: RoleType.SYSTEM,
        department: departmentMap[DepartmentName.OPERATIONS],
        permissions: [
          "area:view",
          ...
          "area:delete",
          "area:approve",
          "area:financials_view",
          "area:compliance_view",
          "area:view",
        ],
        scope: { level: ScopeLevel.GLOBAL },
        uiAccess: UIAccess.ADMIN_PANEL,
        status: RoleStatus.PUBLISHED,
        description: "Area Manager handle the machine installation and creating area",
      },

      [SystemRole.AREA_STAFF]: {
        name: "Area Staff",
        key: "area_staff",
        systemRole: SystemRole.AREA_STAFF,
        type: RoleType.SYSTEM,
        department: departmentMap[DepartmentName.OPERATIONS],
        permissions: [
          "area:view",
        ...
        uiAccess: UIAccess.ADMIN_PANEL,
        status: RoleStatus.PUBLISHED,
        description: "Area Staff handle the creating area",
      },
      [SystemRole.OPS_MANAGER]: {
        name: "Ops Manager",
        key: "ops_manager",
