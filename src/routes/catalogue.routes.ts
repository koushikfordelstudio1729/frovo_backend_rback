...
router.get('/export/sku/csv',authenticate,authorize(MANAGEMENT),catalogueController.exportAllCataloguesCSV.bind(catalogueController)
);
...
router.get(
    '/export/category/csv',authenticate, authorize(MANAGEMENT),categoryController.exportAllCategoriesCSV.bind(categoryController)
);
