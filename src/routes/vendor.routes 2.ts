...
router.patch('/:id/verify', authorize(VENDOR_MANAGEMENT), vendorController.updateVendorVerification.bind(vendorController));
router.post('/bulk-verify', authorize(VENDOR_MANAGEMENT), vendorController.bulkUpdateVendorVerification.bind(vendorController));
router.put('/:id/quick-verify', authorize(VENDOR_MANAGEMENT), vendorController.quickVerifyOrRejectVendor.bind(vendorController));
router.put('/:id/quick-reject', authorize(VENDOR_MANAGEMENT), vendorController.quickVerifyOrRejectVendor.bind(vendorController));
...
router.get('/profile/me', authorize(VENDOR_MANAGEMENT), vendorController.getMyVendorProfile.bind(vendorController));
...
router.get('/:id/audit-trail', authorize(READ_ACCESS), vendorController.getVendorAuditTrail.bind(vendorController));
router.get('/companies/:cin/audit-trail', authorize(READ_ACCESS), vendorController.getCompanyAuditTrail.bind(vendorController));
