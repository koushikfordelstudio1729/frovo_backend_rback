...
export const createWarehouseSchema = z.object({
  body: z.object({
    ...
    code: z
      ...
      .trim()
      .toUpperCase(),
    partner: z.string().min(1, "Partner name is required").trim(),
...
export const updateWarehouseSchema = z.object({
  body: z.object({
    ...
    code: z
      ...
      .toUpperCase()
      .optional(),
    partner: z.string().min(1, "Partner name is required").trim().optional(),
    location: z.string().min(5, "Location must be at least 5 characters").trim().optional(),
    capacity: z
      .number()
      .min(1, "Capacity must be at least 1")
      .max(1000000, "Capacity cannot exceed 1,000,000")
...
export const getWarehousesQuerySchema = z.object({
  query: z.object({
    ...
    sortBy: z.enum(["name", "code", "createdAt", "capacity"]).optional().default("createdAt"),
