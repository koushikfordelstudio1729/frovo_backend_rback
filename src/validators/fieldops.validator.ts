...
export const workSummaryQuerySchema = z.object({
  query: z.object({
    ...
    reportType: z.enum(['pickup', 'refill', 'maintenance', 'daily', 'weekly', 'monthly']).optional()
  })
});
...
export const getTasksQuerySchema = z.object({
  query: z.object({
    status: z.enum(['all', 'pending', 'in_progress', 'completed', 'skipped', 'cancelled']).optional(),
