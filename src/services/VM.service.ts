...
export class MachineService {
  ...
  static async createMachine(machineData: any, auditParams?: AuditLogParams) {
    try {
      ...
      if (machineData.machineId) {
        const machineIdPattern = /^VM\d{7}$/; // VM + 7 digits (4 year + 3 sequence)
        ...
        // Extract year from machineId and validate it's not from past years
      ...
      // If machineId not provided, it will be auto-generated by pre-save middleware
  ...
  static async checkMachineExists(machineId: string): Promise<boolean> {
    try {
      // Search by the custom machineId field, not MongoDB _id
